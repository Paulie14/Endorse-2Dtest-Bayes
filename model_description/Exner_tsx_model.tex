...
\cleardoublepage
    ...
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{graphics/bayes/hist_G3.pdf}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{graphics/bayes/hist_G4.pdf}
    \end{subfigure}
    %}
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_02_init_per_borehole/G1/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g1_lin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_02_init_per_borehole/G1/histograms2.pdf}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_02_init_per_borehole/G2/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g2_lin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_02_init_per_borehole/G2/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_02_init_per_borehole/G3/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g3_lin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_02_init_per_borehole/G3/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_02_init_per_borehole/G4/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g4_lin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_02_init_per_borehole/G4/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_03_nonlinear_per_borehole/G1/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g1_nonlin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_03_nonlinear_per_borehole/G1/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
      \label{fig:hist_g1_lin_params}
    \end{subfigure}
    \caption{Výsledky pro pozorovací vrt HGT1-5.}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_03_nonlinear_per_borehole/G2/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g2_lin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_03_nonlinear_per_borehole/G2/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
      \label{fig:hist_g2_lin_params}
    \end{subfigure}
    \caption{Výsledky pro pozorovací vrt HGT1-4.}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_03_nonlinear_per_borehole/G3/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g3_lin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_03_nonlinear_per_borehole/G3/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
      \label{fig:hist_g3_lin_params}
    \end{subfigure}
    \caption{Výsledky pro pozorovací vrt HGT2-3.}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_03_nonlinear_per_borehole/G4/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g4_lin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_03_nonlinear_per_borehole/G4/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
      \label{fig:hist_g4_lin_params}
    \end{subfigure}
    \caption{Výsledky pro pozorovací vrt HGT2-4.}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_04_nonlinear_per_borehole/G1/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g1_nonlin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_04_nonlinear_per_borehole/G1/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
      \label{fig:hist_g1_lin_params}
    \end{subfigure}
    \caption{Výsledky pro pozorovací vrt HGT1-5.}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_04_nonlinear_per_borehole/G2/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g2_lin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_04_nonlinear_per_borehole/G2/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
      \label{fig:hist_g2_lin_params}
    \end{subfigure}
    \caption{Výsledky pro pozorovací vrt HGT1-4.}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_04_nonlinear_per_borehole/G3/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g3_lin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_04_nonlinear_per_borehole/G3/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
      \label{fig:hist_g3_lin_params}
    \end{subfigure}
    \caption{Výsledky pro pozorovací vrt HGT2-3.}
...
\begin{figure}[htb!]
    \centering
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_04_nonlinear_per_borehole/G4/hist_G1.pdf}
      \caption{Histogram odezvy tlaku v pozorovacím vrtu.}
      \label{fig:hist_g4_lin}
    \end{subfigure}
    \begin{subfigure}[t]{0.495\textwidth}
      \includegraphics[width=\textwidth]{\respath SAVE_04_nonlinear_per_borehole/G4/histograms2.pdf}
      \caption{Histogramy empirických marginálních posteriorních rozdělení.}
      \label{fig:hist_g4_lin_params}
    \end{subfigure}
    \caption{Výsledky pro pozorovací vrt HGT2-4.}
